...
import logging
logger = logging.getLogger('mangar_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by MangarWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseMangarWindow object.
        """
        builder = get_builder('MangarWindow')
        new_object = builder.get_object("mangar_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a MangarWindow object with it in order to finish
        initializing the start of the new MangarWindow instance.
        """
        ...
        #    LaunchpadIntegration.set_sourcepackagename('mangar')
        #except ImportError:
        #    pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for mangar."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for mangar."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MangarWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MangarWindow is closed."""
